...
echo "  codescope index-parallel /path/to/project"
echo ""
echo "Or start MCP server:"
echo "  codescope"
echo ""
echo "Large project? Tune the built-in multi-process scheduler:"
echo "  codescope index-parallel /path/to/large/project --workers 8 --parallel 4"

...
public:
	const char *name() const override { return "BuildSymbolIndex"; }
...
public:
	const char *name() const override { return "ResolveCalls"; }
	bool run(uint64_t project_id,
		 std::vector<std::unique_ptr<ir::TranslationUnit>> &units,
		 const std::vector<std::string> &file_paths,
		 resolver::ProjectSymbolIndex &symbol_index,
...
public:
	const char *name() const override { return "EmitGraph"; }
	bool run(uint64_t project_id,
		 std::vector<std::unique_ptr<ir::TranslationUnit>> &units,
		 const std::vector<std::string> &file_paths,
		 resolver::ProjectSymbolIndex &symbol_index,

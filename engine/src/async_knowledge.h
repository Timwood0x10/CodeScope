...
/// Launch the async knowledge graph builder for a project.
/// Returns immediately; construction runs in a joinable background thread.
/// @param project_id  The project to build the knowledge graph for.

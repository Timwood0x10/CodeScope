...
class SemanticEmitter {
	...
	/// Emit an interface/trait implementation record.
	/// \param impl_type    The implementing type name (struct/class)
	/// \param iface_name   The interface/trait name
	uint64_t emitInterfaceImpl(const std::string &impl_type,

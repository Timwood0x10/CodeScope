...
Node *JavaTranslator::translateNode(TSNode ts_node, Node *parent) {
  ...
  if (strcmp(type, "expression_statement") == 0 || strcmp(type, "block") == 0 ||
      ...
      strcmp(type, "array_type") == 0 || strcmp(type, "generic_type") == 0 ||
      ...
      strcmp(type, "dimensions") == 0 || strcmp(type, "dimensions_expr") == 0 ||
...
Translator *createJavaTranslator() { return new JavaTranslator(); }

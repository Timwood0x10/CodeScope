...
class JavaTranslator : public Translator {
  public:
    const char *language() const override { return "java"; }
...
Node *JavaTranslator::translateNode(TSNode ts_node, Node *parent) {
    ...
    if (strcmp(type, "for_statement") == 0 || strcmp(type, "enhanced_for_statement") == 0) {
    ...
    if (strcmp(type, "string_literal") == 0 || strcmp(type, "character_literal") == 0 ||
        strcmp(type, "decimal_integer_literal") == 0 || strcmp(type, "hex_integer_literal") == 0 ||
        strcmp(type, "octal_integer_literal") == 0 ||
        strcmp(type, "decimal_floating_point_literal") == 0 ||
        strcmp(type, "hex_floating_point_literal") == 0 || strcmp(type, "boolean_literal") == 0 ||
    ...
    if (strcmp(type, "expression_statement") == 0 || strcmp(type, "block") == 0 ||
        strcmp(type, "class_body") == 0 || strcmp(type, "interface_body") == 0 ||
        strcmp(type, "enum_body") == 0 || strcmp(type, "formal_parameters") == 0 ||
        strcmp(type, "argument_list") == 0 || strcmp(type, "array_initializer") == 0 ||
        strcmp(type, "argument_list") == 0 || strcmp(type, "type_parameters") == 0 ||
        strcmp(type, "type_arguments") == 0 || strcmp(type, "type_identifier") == 0 ||
        strcmp(type, "variable_declarator") == 0 || strcmp(type, "modifier") == 0 ||
        strcmp(type, "annotation") == 0 || strcmp(type, "scoped_identifier") == 0 ||
        strcmp(type, "parenthesized_expression") == 0 || strcmp(type, "array_type") == 0 ||
        strcmp(type, "generic_type") == 0 || strcmp(type, "superclass") == 0 ||
        strcmp(type, "super_interfaces") == 0 || strcmp(type, "enum_constant") == 0 ||
        strcmp(type, "explicit_generic_instantiation") == 0 || strcmp(type, "dimensions") == 0 ||
        strcmp(type, "dimensions_expr") == 0 || strcmp(type, "element_value_pair") == 0) {

...
Node *JavascriptTranslator::translateNode(TSNode ts_node, Node *parent) {
    ...
    if (strcmp(type, "expression_statement") == 0 || strcmp(type, "statement_block") == 0 ||
        ...
        strcmp(type, "property_identifier") == 0 || strcmp(type, "variable_declarator") == 0 ||
        strcmp(type, "class_body") == 0 || strcmp(type, "field_definition") == 0 ||
        strcmp(type, "decorator") == 0 || strcmp(type, "export_clause") == 0 ||
        strcmp(type, "import_clause") == 0 || strcmp(type, "namespace_import") == 0 ||

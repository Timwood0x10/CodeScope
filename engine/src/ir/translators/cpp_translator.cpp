...
Node *CppTranslator::translateNode(TSNode ts_node, Node *parent) {
  ...
  if (strcmp(type, "number_literal") == 0 ||
      ...
      strcmp(type, "false") == 0 || strcmp(type, "nullptr") == 0 ||
      strcmp(type, "null") == 0) {
  ...
  if (strcmp(type, "expression_statement") == 0 ||
      ...
      strcmp(type, "enumerator_list") == 0 || strcmp(type, "decltype") == 0 ||
...
Node *CppTranslator::handleFuncDef(TSNode ts_node, Node *parent) {
  ...
  auto *func = makeNode(
      is_method ? NodeKind::MethodDecl : NodeKind::FunctionDecl, ts_node);
...
Translator *createCppTranslator() { return new CppTranslator(); }

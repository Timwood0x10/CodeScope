...
TranslationUnit *TypescriptTranslator::translate(TSTree *tree,
                                                 const char *source,
...
Node *TypescriptTranslator::translateNode(TSNode ts_node, Node *parent) {
  ...
  if (strcmp(type, "expression_statement") == 0 ||
      ...
      strcmp(type, "named_imports") == 0 || strcmp(type, "from_clause") == 0 ||
...
Translator *createTypescriptTranslator() { return new TypescriptTranslator(); }

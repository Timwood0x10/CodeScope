...
const char* kindName(NodeKind k) {
    switch (k) {
        ...
        case NodeKind::ParameterDecl:    return "ParameterDecl";
        case NodeKind::EnumDecl:         return "EnumDecl";
        case NodeKind::EnumMemberDecl:   return "EnumMemberDecl";
        case NodeKind::TypeAliasDecl:    return "TypeAliasDecl";
        case NodeKind::TemplateDecl:     return "TemplateDecl";
        ...
        case NodeKind::CatchStmt:        return "CatchStmt";
        ...
        case NodeKind::NewExpr:          return "NewExpr";
...
const char* relationName(Relation r) {
    switch (r) {
        ...
        case Relation::TypeRef:    return "TypeRef";
        case Relation::SymbolRef:  return "SymbolRef";
        case Relation::CallTarget: return "CallTarget";
        case Relation::Receiver:   return "Receiver";
        case Relation::BaseClass:  return "BaseClass";
    }
    return "Unknown";
}

...
unsafe extern "C" {
    ...
    fn engine_get_communities(project_id: u64, max_members: i32) -> *mut c_char;
...
pub fn get_communities(project_id: u64, max_members: i32) -> String {
    take_string(unsafe { engine_get_communities(project_id, max_members) })
}
